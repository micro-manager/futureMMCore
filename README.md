...
Familiarity with the current design of the Micro-Manager core is useful for the issues discussed here. We prepared a manuscript desribing the current design, its advantages and some shortcomings/omissions [MMCoreDesign.pdf](https://github.com/nicost/futureMMCore/blob/pdf/MMCoreDesign.pdf).
